...
class ajaxClass extends PageClass{
	...
	public function getFilterByMonthInfo(){
		...
		*/
		public function filterByNameHTML(){
			...
			$strFilterByNameHTML = '
				<script>
					function loadXMl(){						
						...
						xmlhttp.open("GET","data.php?inputKey="+inputKey,true);
						xmlhttp.send();
					}
				</script>
			...
			$strFilterByNameHTML .= '<input type="text" id="inputKey">
							<button type="button" onclick="loadXMl()" name="submit">Submit</button>
